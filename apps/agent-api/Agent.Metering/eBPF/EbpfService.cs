...
using Agent.Core.Services.PostgreSQL; // 引入PostgreSQL服务 
using Agent.Core.Models; // 引入数据模型 
using OpenTelemetry.Trace; // 引入OpenTelemetry追踪 
using OpenTelemetry; // 引入OpenTelemetry 
