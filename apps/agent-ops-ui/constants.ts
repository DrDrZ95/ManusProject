...
export const TRANSLATIONS = {
  en: {
    dashboard: "Dashboard",
    mlops: "MLOps Workflow",
    localModel: "Local Model Auto",
    kubernetes: "Kubernetes Info",
    dataTools: "Data Analysis Tools",
    projects: "Project Management",
    filesystem: "Filesystem Center",
    settings: "Settings",
    ...
    searchPlaceholder: "Search modules, logs, or resources...",
    ...
    loginTitle: "ManusProject Control Plane",
    loginSubtitle: "Enterprise MLOps & Infrastructure Management",
    username: "Username",
    password: "Password",
    login: "Sign In",
  ...
  zh: {
    ...
    restartNode: "重启节点",
    queryStatus: "查询状态",
    loginTitle: "ManusProject 统一控制平面",
    loginSubtitle: "企业级 MLOps 与基础设施管理系统",
    username: "用户名",
    password: "密码",
    login: "登录系统",
    projectCatalog: "项目列表",
...
export const MOCK_LOCAL_MODELS: LocalModel[] = [
  { id: 'm1', name: 'LLaMA-7B-Finance', baseModel: 'llama-2-7b', status: 'Fine-Tuning', accuracy: 88, precision: 85, recall: 90, epoch: 14, totalEpochs: 20 },
  { id: 'm2', name: 'BERT-Sentiment-CN', baseModel: 'bert-base-chinese', status: 'Deployed', accuracy: 94, precision: 92, recall: 93, epoch: 10, totalEpochs: 10 },
  { id: 'm3', name: 'ResNet-50-QC', baseModel: 'resnet-50', status: 'Idle', accuracy: 76, precision: 70, recall: 78, epoch: 0, totalEpochs: 50 },
];
