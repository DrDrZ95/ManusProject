...
# Script to set up the environment for deepseek-ai/DeepSeek-R1-Distill-Qwen3-4B model

set -e  # Exit immediately if a command exits with a non-zero status

echo "Setting up environment for deepseek-ai/DeepSeek-R1-Distill-Qwen3-4B model..."
...
# einops and tiktoken are often used with deepseek models
